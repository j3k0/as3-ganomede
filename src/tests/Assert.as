...
package tests {
	...
	public class Assert {
		 ...
		 * @throws org.as3commons.lang.Error if the expression is not <code>true</code>
		 */
		 ...
		 * @param message the error message to use if the assertion fails
		 * @throws org.as3commons.lang.Error if the object is not <code>null</code>
		 */
		 ...
		 * @param object the object to check
		 * @param message the error message to use if the assertion fails
		 * @throws org.as3commons.lang.Error if the object is not an instance of the given type
		 */
		...
		/**
		 * Assert a boolean expression to be true. If false, an Error is thrown.
		 * @param expression a boolean expression
